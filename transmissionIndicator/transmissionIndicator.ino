...
//Pin definitions
int firstGear = 1; //Blue LED, pin 1
int secondGear = 2; //Green LED, pin 2
int thirdGear = 3; //Yellow LED, pin 3
int fourthGear = 4; //Red LED, pin 4, Overdrive
...
void loop() {
  ...
  if(gearVoltage < 1.49999){ //1st Gear position
